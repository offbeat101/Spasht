...
with st.sidebar:
    ...
    # Colab-specific info
    st.header("Colab Info")
    st.warning(
        "This app is running in Google Colab. Keep the notebook running to maintain the connection."
    )
...
st.markdown(
    ...
    "Retail Inventory Optimization System | Developed with Streamlit and Python | Running in Google Colab"
    "</div>",
    unsafe_allow_html=True
)
